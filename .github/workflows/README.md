...
This README file documents the format of the `release_configurations.json` file located in this directory.  The file defines Eterm's various release channels, and provides values for the various variables that are necessary to run the GitHub release workflow.
