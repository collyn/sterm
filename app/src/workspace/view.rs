...
// We use the word "STerm" in the Update Ready button to make it obvious that the terminal is STerm.
// This can lead to free advertising when users screen-share STerm when an update is available.
