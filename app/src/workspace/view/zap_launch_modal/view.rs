...
fn feature_items() -> [FeatureItem; 3] {
    [
        FeatureItem {
            icon: Icon::HeartHand,
            title: crate::t!("sterm-launch-contribute-title"),
            description: crate::t!("sterm-launch-contribute-description"),
            inline_link: Some(InlineLink {
                text: crate::t!("sterm-launch-contribute-link-text"),
                url: CONTRIBUTING_URL,
            }),
        },
        FeatureItem {
            icon: Icon::Oz,
            title: crate::t!("sterm-launch-oad-title"),
            description: crate::t!("sterm-launch-oad-description"),
            inline_link: None,
        },
        FeatureItem {
            icon: Icon::MessageChatSquare,
            title: crate::t!("sterm-launch-auto-model-title"),
            description: crate::t!("sterm-launch-auto-model-description"),
            inline_link: None,
        },
    ]
}
...
impl ZapLaunchModal {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        let cta_button = ctx.add_view(|_ctx| {
            ActionButton::new(crate::t!("sterm-launch-visit-repo"), CtaButtonTheme)
    ...
    fn render_description(appearance: &Appearance) -> Box<dyn Element> {
        Text::new(
            crate::t!("sterm-launch-description"),
            appearance.ui_font_family(),
            14.,
        )
