...
fn main() -> Result<()> {
    let mut state = ChannelState::new(
        Channel::Oss,
        ChannelConfig {
            app_id: AppId::new("dev", "sterm", "STerm"),
            logfile_name: "sterm.log".into(),
...
embed_plist::embed_info_plist_bytes!(r#"
    ...
    <array><dict><key>CFBundleURLName</key><string>Custom App</string><key>CFBundleURLSchemes</key><array><string>sterm</string></array></dict></array>
    <key>NSHumanReadableCopyright</key>
    <string>© 2026, STerm</string>
    </dict>
    </plist>
"#.as_bytes());
