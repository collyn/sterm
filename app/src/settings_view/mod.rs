...
impl FromStr for SettingsSection {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "ZapDrive" | "Zap Drive" | "Drive" => Ok(Self::ZapDrive),
...
impl SettingsView {
    pub fn new(page: Option<SettingsSection>, ctx: &mut ViewContext<Self>) -> Self {
        ...
        let initial_page = match page {
            ...
            Some(section) if section.is_subpage() => {
                if ai_enabled {
                    section
                } else {
                    SettingsSection::Code
            ...
            other => {
                ...
                if !ai_enabled && (section == SettingsSection::WarpAgent || section.is_subpage()) {
                    SettingsSection::Code
                } else {
                    section
                }
    ...
    pub fn set_and_refresh_current_page_internal(
        ...
        let section = match section {
            ...
            other => {
                if !ai_enabled && (other == SettingsSection::WarpAgent || other.is_subpage()) {
                    SettingsSection::Code
                } else {
                    other
                }
