...
STerm 是一个开放、本地优先的终端,带一等公民的 AI 与 Agent 体验。接入任意 AI 提供商、接入任意 CLI Agent、在终端内管理 SSH 主机 —— 密钥、历史与 Agent 状态默认留在本地。
...
## 从 OpenWarp, Zap 或 Warp 迁移过来

如果你在项目改名 STerm 之前就一直在用(那时还叫 **OpenWarp** 或 **Zap**),
...
- [Warp](https://github.com/warpdotdev/warp) —— STerm 所基于的上游终端。
