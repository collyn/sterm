...
#define MyAppURL "https://zap.zerx.dev/"
  ...
  ; 默认跟随官方 channel 的 `dev.warp.*` 命名;OSS 在 bundle.ps1 里会覆盖为 `dev.sterm.STerm`。
...
; bundle.ps1 会为 OSS 传入 `InnoAppId=sterm`,其他 channel 走默认的 `warp-terminal-{ReleaseChannel}`。
#ifndef InnoAppId
