...
#[test]
fn test_svg_generic_sans_serif_rasterizes() {
    let svg = "<svg width=\"160\" height=\"40\" viewBox=\"0 0 160 40\" xmlns=\"http://www.w3.org/2000/svg\">\
  <text x=\"10\" y=\"24\" font-family=\"sans-serif\" font-size=\"20\" fill=\"#000000\">Zap</text>\
</svg>";
    let image_type =
        ImageType::try_from_bytes(svg.as_bytes()).expect("SVG with sans-serif should parse");
    let image = image_type
        .to_image(
            Vector2I::new(160, 40),
            FitType::Contain,
